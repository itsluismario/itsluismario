...
const AboutMe = () => {
  return (
    <a
    className="text-left max-w-screen-sm group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800 hover:dark:bg-opacity-30"
    target="_blank"
    ...
    >
        ...
        I'm an engineer, graduated from Tecnologico de Monterrey, who had the incredible opportunity to work and learn from remarkable change-makers at Harvard: Dr. Su Ryon Shin at Shin Lab, and Dr. Banu Ahtam and Ellen Grant at FNNDSC. Recognizing the privileged position I've been in, I've chosen to dedicate my time to creating companies that solve society's unsolved problems. My goal is to make a meaningful impact and contribute to a better world through computer science.
        </p>
        <br/>
        <p className="text-sm opacity-90 ">
